...
namespace CFVG_Card_Creator
{
    ...
    class SpecialLayer : ImageLayer
    {
        ...
        public new void DrawImage(Graphics g)
        {
            ...
            path.AddString(value, valueFont.FontFamily, (int)valueFont.Style, 10.9f, new Point(base.posX + 15 + (outline == null ? 0 : 1), base.posY + (outline == null ? 0 : 1)), new StringFormat());
